...
<template>
  <el-row gutter="30" class="full-height">
    ...
    <!-- 新开的编辑页面 -->
    <el-col v-if="showCard && showEditCard" :span="8" class="full-height">
        ...
        <el-scrollbar style="max-height: 86vh; overflow-y: auto">
          <el-collapse>
            <el-collapse-item name="1">
              ...
              <div v-for="step in selectedContent.values"
              :key="step.id">
                <el-input
                  placeholder="输入内容"
...
.task-item:hover {
  background-color: #cccccc; /* 悬浮时的背景颜色 */
  cursor: pointer;
}
